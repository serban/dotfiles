...
M.bind_pri('n',     function() a.activate('NetNewsWire.app') end)
...
M.bind_sec('d',     function() x.disableAXEnhancedUserInterface(true) end)
M.bind_sec('e',     function() a.activate('TextEdit.app') end)
...
M.bind_sec('i',     function() a.activate('iPhone Mirroring.app') end)
M.bind_sec('j',     function() a.activate('RustRover.app') end)
M.bind_sec('k',     function() a.activate('Ghostty.app') end)
M.bind_sec('l',     function() p.placeWindows() end)
M.bind_sec('m',     function() a.activate('Home.app') end)
