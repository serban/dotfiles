...
--bind_pri('space', ) -- Mission Control › Mission Control
M.bind_pri('return', M.nop)

M.bind_pri('.',     M.nop) -- Shadow System Diagnostics trigger
M.bind_pri(',',     M.nop) -- Shadow System Diagnostics folder /private/var/tmp
M.bind_pri('/',     M.nop)

M.bind_pri('[',     function() x.disableAXEnhancedUserInterface(true) end)
M.bind_pri(']',     function() p.placeWindows() end)
...
M.bind_pri('tab',   function() a.highlightMousePointer() end)

--bind_pri('a',     ) -- Mission Control › Application Windows
M.bind_pri('b',     function() a.activate('Firefox.app') end)
M.bind_pri('c',     function() a.activate('Google Chrome.app') end)
M.bind_pri('d',     function() a.activate('Numbers.app') end)
M.bind_pri('e',     function() a.activate('SoundSource.app') end)
M.bind_pri('f',     function() a.activate('Finder.app') end)
M.bind_pri('g',     function() a.activate('Ghostty.app') end)
M.bind_pri('h',     function() a.activate('Home.app') end)
...
M.bind_pri('o',     function() a.activate('TextEdit.app') end)
...
M.bind_pri('w',     function() a.activate('WezTerm.app') end)
...
M.bind_pri('4',     function() a.activate('QuickTime Player.app') end)
M.bind_pri('5',     function() a.activate('VLC.app') end)
M.bind_pri('6',     function() a.activate('YouTube Music.app') end)
M.bind_pri('7',     function() a.activate('TIDAL.app') end)

M.bind_sec('a',     function() a.activate('Activity Monitor.app') end)
M.bind_sec('b',     function() a.activate('Capo.app') end)
M.bind_sec('c',     function() a.activate('Contacts.app') end)
M.bind_sec('d',     M.nop)
M.bind_sec('e',     M.nop)
M.bind_sec('f',     function() a.activate('FindMy.app') end)
M.bind_sec('g',     function() a.activate('Pages.app') end)
M.bind_sec('h',     M.nop)
M.bind_sec('i',     function() a.activate('iReal Pro.app') end)
M.bind_sec('j',     function() a.activate('RustRover.app') end)
M.bind_sec('k',     M.nop)
M.bind_sec('l',     M.nop)
M.bind_sec('m',     function() a.activate('iPhone Mirroring.app') end)
M.bind_sec('n',     function() a.activate('NetNewsWire.app') end)
M.bind_sec('o',     function() a.activate('Obsidian.app') end)
M.bind_sec('p',     function() a.activate('Photo Booth.app') end)
M.bind_sec('q',     function() a.activate('Neovide.app') end)
M.bind_sec('r',     function() a.activate('Reminders.app') end)
M.bind_sec('s',     function() a.activate('Signal.app') end)
M.bind_sec('t',     M.nop)
M.bind_sec('u',     function() a.activate('MuseScore 4.app') end)
M.bind_sec('v',     function() a.activate('Visual Studio Code.app') end)
M.bind_sec('w',     function() a.activate('Weather.app') end)
M.bind_sec('x',     function() a.activate('Xcode.app') end)
M.bind_sec('y',     M.nop)
M.bind_sec('z',     M.nop)

M.bind_sec('1',     function() f.openFinderHomeDirsStacked() end)
M.bind_sec('2',     function() f.openFinderHomeDirsTiled() end)
M.bind_sec('3',     M.nop)
M.bind_sec('4',     function() a.openFirefoxHomeTabs() end)
M.bind_sec('5',     function() a.openFirefoxChatTabs() end)
M.bind_sec('6',     function() a.openChromeHomeTabs() end)
M.bind_sec('7',     M.nop)
M.bind_sec('8',     M.nop)
M.bind_sec('9',     M.nop)
M.bind_sec('0',     M.nop)
