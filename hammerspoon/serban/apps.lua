...
M.kPlacement = {
  ...
  { app='QuickTime Player', bun='com.apple.QuickTimePlayerX',         max=true,   [1]={g.kScreenLeft, g.kGridTop},          [2]={g.kScreenLeft,   g.kGridTop},        },
  ...
  { app='VLC',              bun='org.videolan.vlc',                   max=true,   [1]={g.kScreenLeft, g.kGridMaximized},    [2]={g.kScreenCenter, g.kGridMaximized},  },
