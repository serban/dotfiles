...
syntax match   SerbanUrl               '\v<https?://\S+>'                           containedin=mkdNonListItemBlock,mkdListItemLine nextgroup=SerbanLinkTitle
syntax match   SerbanShortLink         '\v<(b|cl|g|go|google3|g3doc|omg|yaqs)/\S+>' containedin=mkdNonListItemBlock,mkdListItemLine nextgroup=SerbanLinkTitle
syntax match   SerbanLinkTitle         '\v - .*$'                                   containedin=mkdNonListItemBlock,mkdListItemLine
