...
export PATH="${HOME}/bin:${PRIVATE}/bin:${DOTFILES}/bin:${HOME}/env/go/bin:${HOME}/opt/google-cloud-sdk/bin:/usr/local/cuda/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/usr/sbin:/bin:/sbin:${PATH}"
